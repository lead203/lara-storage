        ...
        <nav class="flex items-center justify-between p-1 mb-3">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                <li v-for="ans of ancestors.data" :key="ans.id" class="inline-flex items-center">
                    <Link v-if="!ans.parent_id" :href="route('myFiles')" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 gap-1">
            ...
            <div class="flex items-center gap-4">
                <label>
                    Only Favourites
                    <Checkbox @change="showOnlyFavourites" v-model:checked="onlyFavourites" class="ml-1" />
                </label>
        ...
        <div class="flex-1 overflow-auto">
            <table class="min-w-full">
                ...
                <tr>
                    ...
                    <th class="text-sm font-medium text-gray-900 px-6 py-4 max-w-[40px] text-left">
